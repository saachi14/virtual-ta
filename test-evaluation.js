...
const testCases = [
    {
        ...
        expectedLink: "https://discourse.onlinedegree.iitm.ac.in/t/ga5-question-8-clarification/155939"
    },
    {
        question: "If a student scores 10/10 on GA4 as well as a bonus, how would it appear on the dashboard?",
        expectedAnswerContains: "110",
        expectedLink: "https://discourse.onlinedegree.iitm.ac.in/t/ga4-data-sourcing-discussion-thread-tds-jan-2025/165959"
    },
    {
...
const testApiEndpoint = async (baseUrl) => {
    ...
    for (let i = 0; i < testCases.length; i++) {
        ...
        try {
            const response = await axios_1.default.post(`${baseUrl}/api/`, { question: testCase.question }, {
